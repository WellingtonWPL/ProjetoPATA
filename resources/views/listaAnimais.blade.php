		...
		<div class="col">
			...
			<div class="form-check">
				<input type="checkbox" class="form-check-input"
					id="exampleCheck1" name="0-1" value="0-1">
				<label class="form-check-label"
					for="exampleCheck1">0-1 ano</label>
			</div>
			<div class="form-check">
				<input type="checkbox" class="form-check-input"
					id="exampleCheck1" name="1-3" value="1-3">
				<label class="form-check-label"
...
<div class="card">
	...
	<div class="row " id="" class="card-body">
		...
		<div class="col-9">
			...
			if ($idade<1.0) { echo 'Menos de um ano<br>' ; }elseif
				($idade==1.0) { echo '1 ano<br>' ; }else{ echo (int)
				$idade." anos<br>";
				}
				}
				@endphp
